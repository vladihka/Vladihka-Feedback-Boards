...
import {getRawSourceMap} from "next/dist/client/components/react-dev-overlay/internal/helpers/getRawSourceMap";
                ...
                {showGradientsPopup && (
                    <Popup
                        ...
                        <div className="p-4 grid gap-4 grid-cols-2">
                            {['hyper', 'oceanic', 'cotton-candy', 'gotham',
                            'sunset', 'mojave'].map(styleOptionName => (
                                <label onClick={() => {
